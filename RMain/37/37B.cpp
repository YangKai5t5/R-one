//for ascending order Tell the rank of the entered new mark. Ex: Marks List: {39, 38, 38, 36, 34, 31, 28}, for mark 38 answer is Rank 2, for mark 36 rank is 3 , repeated digits should not be counted
...
int main()
{
    int marks[] ={28, 31, 34, 36, 38, 38, 39}; // Already sorted in descending order
